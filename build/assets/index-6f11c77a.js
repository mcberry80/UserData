 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oh(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Fg(t){const e=t.mapValue.fields.__previous_value__;return Oh(e)?Fg(e):e}function eu(t){const e=br(t.mapValue.fields.__local_write_time__.timestampValue);return new fe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y2=new re(N.comparator);function kt(){return Y2}const YS=new re(N.comparator);function Zo(...t){let e=YS;for(const n of t)e=e.insert(n.key,n);return e}function XS(t){let e=YS;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function _n(){return ya()}function JS(){return ya()}function ya(){return new Yr(t=>t.toString(),(t,e)=>t.isEqual(e))}const X2=new re(N.comparator),J2=new ue(N.comparator);function B(...t){let e=J2;for(const n of t)e=e.add(n);return e}const Z2=new ue(z);function Bg(){return Z2}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LT{constructor(){this.Li=!1}initialize(e,n){this.qi=e,this.indexManager=n,this.Li=!0}getDocumentsMatchingQuery(e,n,r,i){return this.Ui(e,n).next(s=>s||this.Ki(e,n,i,r)).next(s=>s||this.Gi(e,n))}Ui(e,n){if(Yw(n))return v.resolve(null);let r=Rt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Mc(n,null,"F"),r=Rt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=B(...s);return this.qi.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(u=>{const l=this.Qi(n,a);return this.ji(n,l,o,u.readTime)?this.Ui(e,Mc(n,null,"F")):this.zi(e,l,n,u)}))})))}Ki(e,n,r,i){return Yw(n)||i.isEqual($.min())?this.Gi(e,n):this.qi.getDocuments(e,r).next(s=>{const o=this.Qi(n,s);return this.ji(n,o,r,i)?this.Gi(e,n):(_p()<=Q.DEBUG&&S("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Rp(n)),this.zi(e,o,n,CS(i,-1)))})}Qi(e,n){let r=new ue(QS(e));return n.forEach((i,s)=>{bu(e,s)&&(r=r.add(s))}),r}ji(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Gi(e,n){return _p()<=Q.DEBUG&&S("QueryEngine","Using full collection scan to execute query:",Rp(n)),this.qi.getDocumentsMatchingQuery(e,n,Ft.min())}zi(e,n,r,i){return this.qi.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zh(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class O$ extends Py{constructor(e){super(),this.firestore=e}convertBytes(e){return new Rn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new le(this.firestore,null,n)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M$(t){t=J(t,le);const e=J(t.firestore,Ee);return uk(We(e),t._key).then(n=>by(e,t,n))}class Ji extends Py{constructor(e){super(),this.firestore=e}convertBytes(e){return new Rn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new le(this.firestore,null,n)}}function $$(t){t=J(t,le);const e=J(t.firestore,Ee),n=We(e),r=new Ji(e);return e$(n,t._key).then(i=>new Qn(e,r,t._key,i,new gi(i!==null&&i.hasLocalMutations,!0),t.converter))}function F$(t){t=J(t,le);const e=J(t.firestore,Ee);return uk(We(e),t._key,{source:"server"}).then(n=>by(e,t,n))}function U$(t){t=J(t,nt);const e=J(t.firestore,Ee),n=We(e),r=new Ji(e);return kk(t._query),lk(n,t._query).then(i=>new Vr(e,r,t,i))}function V$(t){t=J(t,nt);const e=J(t.firestore,Ee),n=We(e),r=new Ji(e);return t$(n,t._query).then(i=>new Vr(e,r,t,i))}function z$(t){t=J(t,nt);const e=J(t.firestore,Ee),n=We(e),r=new Ji(e);return lk(n,t._query,{source:"server"}).then(i=>new Vr(e,r,t,i))}function U0(t,e,n){t=J(t,le);const r=J(t.firestore,Ee),i=Zh(t.converter,e,n);return Bu(r,[Gh(Yi(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,de.none())])}function V0(t,e,n,...r){t=J(t,le);const i=J(t.firestore,Ee),s=Yi(i);let o;return o=typeof(e=U(e))=="string"||e instanceof Ur?Cy(s,"updateDoc",t._key,e,n,r):ky(s,"updateDoc",t._key,e),Bu(i,[o.toMutation(t._key,de.exists(!0))])}function B$(t){return Bu(J(t.firestore,Ee),[new wo(t._key,de.none())])}function j$(t,e){const n=J(t.firestore,Ee),r=qc(t),i=Zh(t.converter,e);return Bu(n,[Gh(Yi(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,de.exists(!1))]).then(()=>r)}function xk(t,...e){var n,r,i;t=U(t);let s={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||zp(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(zp(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(i=h.complete)===null||i===void 0?void 0:i.bind(h)}let u,l,c;if(t instanceof le)l=J(t.firestore,Ee),c=yo(t._key.path),u={next:h=>{e[o]&&e[o](by(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=J(t,nt);l=J(h.firestore,Ee),c=h._query;const d=new Ji(l);u={next:p=>{e[o]&&e[o](new Vr(l,d,h,p))},error:e[o+1],complete:e[o+2]},kk(t._query)}return function(h,d,p,y){const w=new Bh(y),R=new dy(d,w,p);return h.asyncQueue.enqueueAndForget(async()=>ly(await ro(h),R)),()=>{w.Sc(),h.asyncQueue.enqueueAndForget(async()=>cy(await ro(h),R))}}(We(l),c,a,u)}function q$(t,e){return n$(We(t=J(t,Ee)),zp(e)?e:{next:e})}function Bu(t,e){return function(n,r){const i=new Be;return n.asyncQueue.enqueueAndForget(async()=>xM(await Ey(n),r,i)),i.promise}(We(t),e)}function by(t,e,n){const r=n.docs.get(e._key),i=new Ji(t);return new Qn(t,i,e._key,r,new gi(n.hasPendingWrites,n.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var Is=function(){return Is=Object.assign||function(e){for(var n,r=1,i=arguments.length;r<i;r++){n=arguments[r];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(e[s]=n[s])}return e},Is.apply(this,arguments)},Uk=function(t){return{loading:t==null,value:t}},vF=function(){return function(t,e){switch(e.type){case"error":return Is(Is({},t),{error:e.error,loading:!1,value:void 0});case"reset":return Uk(e.defaultValue);case"value":return Is(Is({},t),{error:void 0,loading:!1,value:e.value});default:return t}}},wF=function(t){var e=t?t():void 0,n=Pt.useReducer(vF(),Uk(e)),r=n[0],i=n[1],s=Pt.useCallback(function(){var u=t?t():void 0;i({type:"reset",defaultValue:u})},[t]),o=Pt.useCallback(function(u){i({type:"error",error:u})},[]),a=Pt.useCallback(function(u){i({type:"value",value:u})},[]);return Pt.useMemo(function(){return{error:r.error,loading:r.loading,reset:s,setError:o,setValue:a,value:r.value}},[r.error,r.loading,s,o,a,r.value])},_F=function(t,e){var n=wF(function(){return t.currentUser}),r=n.error,i=n.loading,s=n.setError,o=n.setValue,a=n.value;return Pt.useEffect(function(){var u=AD(t,function(l){return gF(void 0,void 0,void 0,function(){var c;return yF(this,function(h){switch(h.label){case 0:if(!(e!=null&&e.onUserChanged))return[3,4];h.label=1;case 1:return h.trys.push([1,3,,4]),[4,e.onUserChanged(l)];case 2:return h.sent(),[3,4];case 3:return c=h.sent(),s(c),[3,4];case 4:return o(l),[2]}})})},s);return function(){u()}},[t]),[a,i,r]};function Vk({signInWithGoogle:t}){const[e]=_F(Ms);return pe.jsx("div",{children:e?pe.jsx("button",{onClick:()=>Ms.signOut(),children:"Sign Out"}):pe.jsx("button",{onClick:t,children:"Sign in with Google"})})}Vk.propTypes={signInWithGoogle:Ia.func.isRequired};function zk({user:t}){const e=n=>{n.preventDefault();const r=n.target.elements.message.value;r&&(Kp.collection("messages").add({uid:t.uid,text:r,createdAt:xn.firestore.FieldValue.serverTimestamp()}),n.target.reset())};return pe.jsxs("div",{children:[pe.jsx("h2",{children:"Add Message"}),pe.jsxs("form",{onSubmit:e,children:[pe.jsx("input",{type:"text",name:"message",placeholder:"Enter message"}),pe.jsx("button",{type:"submit",children:"Submit"})]})]})}zk.propTypes={user:Ia.shape({uid:Ia.string.isRequired,displayName:Ia.string.isRequired})};function Bk({user:t}){const[e,n]=Pt.useState([]);Pt.useEffect(()=>{const i=Kp.collection("messages").where("uid","==",t.uid).orderBy("createdAt","desc").onSnapshot(s=>{const o=s.docs.map(a=>({id:a.id,...a.data()}));n(o)});return()=>i()},[t]);const r=i=>{Kp.collection("messages").doc(i).delete()};return pe.jsxs("div",{children:[pe.jsx("h2",{children:"Messages"}),pe.jsx("ul",{children:e.map(i=>pe.jsxs("li",{children:[i.text,pe.jsx("button",{onClick:()=>r(i.id),children:"Delete"})]},i.id))})]})}Bk.propTypes={user:Ia.object.isRequired};function IF(){const[t,e]=Pt.useState(null);Pt.useEffect(()=>{const i=Ms.onAuthStateChanged(s=>{e(s||null)});return()=>i()},[]);const n=()=>{Ms.signInWithPopup(cF).then(i=>{e(i.user)}).catch(i=>{console.log(i.message)})},r=()=>{Ms.signOut().then(()=>{e(null)}).catch(i=>{console.log(i.message)})};return pe.jsxs("div",{children:[pe.jsx("h1",{children:"My App"}),t?pe.jsxs("div",{children:[pe.jsxs("p",{children:["Welcome, ",t.displayName]}),pe.jsx("button",{onClick:r,children:"Sign Out"}),pe.jsx(zk,{user:t}),pe.jsx(Bk,{user:t})]}):pe.jsx(Vk,{signInWithGoogle:n})]})}Ms.onAuthStateChanged(t=>{gN.render(pe.jsx(sC.StrictMode,{children:pe.jsx(IF,{user:t})}),document.getElementById("root"))});
